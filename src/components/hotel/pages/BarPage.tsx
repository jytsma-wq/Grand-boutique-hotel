  ...
  return (
    <main className="min-h-screen pt-20">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">The Experience</span>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3 text-charcoal-700">
                  <Martini className="text-charcoal-900" size={18} />
                  <span className="uppercase tracking-wide text-sm font-medium">Signature Cocktails</span>
                </div>
                <div className="flex items-center gap-3 text-charcoal-700">
                  <Sparkles className="text-charcoal-900" size={18} />
            ...
            >
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-charcoal-900 p-6 max-w-xs border-l-4 border-white">
                <div className="flex items-center gap-3">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">Ancient Traditions</span>
            <h2 className="section-title mt-4">Georgian Wine Selection</h2>
            <p className="text-charcoal-600 max-w-2xl mx-auto mt-6 font-light leading-relaxed">
              ...
              <table className="w-full">
                ...
                <tbody>
                  {wineSelection.map((wine, i) => (
                    <tr key={i} className="border-b border-charcoal-200 hover:bg-charcoal-50 transition-colors">
                      <td className="py-5 text-charcoal-600 font-light">{wine.region}</td>
                      <td className="py-5 font-bold text-charcoal-900 uppercase tracking-wide text-sm">{wine.type}</td>
      ...
      <section className="py-24 bg-charcoal-50">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">Premium Selection</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {spirits.map((spirit, i) => (
              <motion.div
                ...
                className="bg-white p-8 border-2 border-charcoal-900"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-3 uppercase tracking-wide">{spirit.category}</h3>
                <p className="text-sm text-charcoal-600 font-light">{spirit.brands}</p>
              </motion.div>
            ))}
          </div>
        </div>
