    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="relative h-[70vh] min-h-[600px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center text-white px-6">
          <motion.div {...fadeInUp}>
            <Flame className="w-16 h-16 text-white mb-6 mx-auto" />
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-sm uppercase tracking-wider text-white/60">Temperature & Humidity</div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeInUp}>
              <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">Luxury Wellness</span>
