  ...
  return (
    <main className="min-h-screen pt-20">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto">
            <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">Complimentary</span>
      ...
      <section className="py-24 bg-charcoal-50">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center mb-16">
            <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">Our Selection</span>
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 flex items-center gap-3">
                    <div className="w-10 h-10 bg-white flex items-center justify-center">
                      <category.icon className="w-5 h-5 text-charcoal-900" />
                    </div>
                  ...
                  <ul className="space-y-4">
                    {category.items.map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-charcoal-900 mt-2 flex-shrink-0" />
                        <div>
                          <div className="font-medium text-charcoal-900 text-sm uppercase tracking-wide">{item.name}</div>
                          <div className="text-xs text-charcoal-500 font-light">{item.desc}</div>
                        </div>
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto">
            <span className="text-charcoal-500 text-xs tracking-[0.3em] uppercase font-light">Dietary Options</span>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Vegetarian', 'Vegan', 'Gluten-Free', 'Halal', 'Dairy-Free', 'Nut-Free'].map((diet) => (
                <span key={diet} className="px-4 py-2 border-2 border-charcoal-200 text-charcoal-700 text-sm uppercase tracking-wider">
                  {diet}
                </span>
              ))}
            </div>
          ...
          <motion.div {...fadeInUp}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href={`/${locale}/restaurant`}>
                <Button variant="outline" className="px-12 py-5 border-2 border-white bg-transparent text-white hover:bg-white hover:text-charcoal-900 uppercase tracking-wider">
                  View Full Menu
                </Button>
              </Link>
            </div>
